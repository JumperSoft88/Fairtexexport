...
<body id="page-top">
 ...
 -->
    ...
    <div class="row " >
      ...
      <div class="col-10">
          <form  action="<?php echo base_url(); ?>products/insertCustomer/insert" method="POST"> 
              <div class="row">
                  <div class="col-3 "></div> 
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body"> 
          ...
          <input type="text" class="form-control" id="edit_product_detail_id" name="edit_product_detail_id" hidden>
            ...
            $.ajax({
              ...
              success: function(response) { 
                ...
                $("#modalEdit").modal('show');
                 ...
                 document.getElementById("edit_product_detail_id").value = response['product_detail_id'];
