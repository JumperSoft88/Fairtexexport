            ...
            <div class="col-10">  
                ...
                <table class="table table-striped table-bordered mydatatable" style="width: 100%" id="mydatatable">
                    ...
                    <body>
                        ...
                        <?php foreach ($_SESSION['historyInvoice'] as $item) { ?> 
                            <tr>
        ...
        $('.mydatatable').DataTable({
          ...
          "footerCallback": function ( row, data, start, end, display ) {
            ...
            var subTotal = api
              ...
              //alert(subTotal);
              document.getElementById("subSumtotal").innerHTML = formatNumber(subTotal) +"$";
             ...
             // alert(total);
              document.getElementById("sumtotal").innerHTML = formatNumber(total) +"$";
