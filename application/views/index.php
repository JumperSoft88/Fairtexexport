...
<body id="page-top">
  ...
  <header class="text-white text-center" >
		<div id="demo" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<img src="<?php echo base_url(); ?>assets/img/slider/3.jpg" alt="Los Angeles" width="1100" height="500">
				...
				<img src="<?php echo base_url(); ?>assets/img/slider/shop.jpg" alt="Chicago" width="1100" height="500">
				<div class="carousel-caption">
				<!-- 	<h3>Chicago</h3>
				...
				<div class="carousel-item">
				<img src="<?php echo base_url(); ?>assets/img/slider/2.jpg" alt="New York" width="1100" height="500">
				<div class="carousel-caption">
					<!-- <h3>New York</h3>
 ...
 -->
  ...
  <section class="text-white mb-0" id="about">
    <div class="container" >
		<img src="<?php echo base_url(); ?>assets/img/slider/shop.jpg" width="1100" height="500">
